...
function format_expire_date(object, e) {
    ...
    if (year_text.length == 0) {
        ...
        $(object).prop('selectionStart', month_text.length)
        $(object).prop('selectionEnd', month_text.length)
    }

    $(object).val(final_value)
}
